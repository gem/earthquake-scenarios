...
oq engine --run job_rup-AUST_gmpe-GEM_seismic.ini --log-file log_rup-AUST_gmpe-GEM_seismic.txt
oq engine --run job_rup-AUST_gmpe-GEM_all.ini --log-file log_rup-AUST_gmpe-GEM_all.txt
oq engine --run job_rup-AUST_gmpe-USGS_seismic.ini --log-file log_rup-AUST_gmpe-USGS_seismic.txt
oq engine --run job_rup-AUST_gmpe-USGS_all.ini --log-file log_rup-AUST_gmpe-USGS_all.txt
